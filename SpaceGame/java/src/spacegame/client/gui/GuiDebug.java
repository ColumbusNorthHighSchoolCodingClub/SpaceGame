...
public class GuiDebug extends Gui {
	...
	public void updateGui() {
		...
		String isConnected = "Connected To a Server: " + clMain.getClientComm().isConnected();
		String numberPlayers = "Number of Players: " + clMain.getClientRoster().getPlayers().size();
		String playerNum = "Player Number: N/A", sectW = "Universe Width: N/A", sectH = "Universe Height: N/A";
		...
		debug = new String[] {
				...
				"Mouse X: " + clMain.getMousePosition().x,
