...
public class Ships implements Packable {
	...
	public void setNumShips(int newNum) {
	...
	public void setDest(int targX, int targY) {
	
		destX = targX;
		destY = targY;
	}
	
	public void setXDest(int targX) {
	
		destX = targX;
	}
	
	public void setYDest(int targY) {
	...
	public String pack() {
		...
		String output = "SHIP" + PARSE_CHAR + playerNum + PARSE_CHAR + numShips + PARSE_CHAR + destX + PARSE_CHAR + destY;
		return output;
	}
