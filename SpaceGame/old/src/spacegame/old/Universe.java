...
//     }
    ...
    private void slideAcross()
    {
       ...
       if(mouseX<=30)changingX+=scrollSlider*2;//offsets the animation right five pixels 
       if(mouseY<=30)changingY+=scrollSlider*2;//offsets the animation down five pixels
