...
public class ShipStats implements Packable {
	...
	private class speedButtonAL implements ActionListener {
		public void actionPerformed(ActionEvent ev) {
			...
			if (Roster.getPlayer(ClientMain.myPlayerNum).getMaterials() > speedCost) {
				...
				Roster.getPlayer(ClientMain.myPlayerNum).setMaterials(Roster.getPlayer(ClientMain.myPlayerNum).getMaterials() - speedCost);
	...
	public int getSpeed() {
		...
		return (int) speed;
	}//others can recieve the speed stat
	
	public void setSpeed(int in) {
	
		speed = in;
	}//others can set the speed stat if upgraded
	
	public int getAttack() {
	
		return (int) attack;
	}//others can attack the speed stat
	
	public void setAttack(int in) {
	
		attack = in;
	}//others can set the attack stat if upgraded
	
	public int getDefense() {
	
		return (int) defense;
	}//others can recieve the defense stat
	
	public void setDefense(int in) {
	
		defense = in;
	}//others can set the defense stat if upgraded
