...
public class Technology implements Packable {
	...
	//prices - TBD could change depending on rate at which minerals are being acquired
	...
	//Modifiers
	public void setFuelSpeed(int newFuelSpeed) {

		fuelSpeed = newFuelSpeed;
	}

	public void setMineSpeed(int newMineSpeed) {

		mineSpeed = newMineSpeed;
	}

	public void setStealthness(int newStealth) {
	...
	private class fuelButtonAL implements ActionListener {
		...
		public void actionPerformed(ActionEvent ev) {
			...
			if(Roster.getPlayer(ClientMain.myPlayerNum).getMoney() >= fuelCost) {
				...
				Roster.getPlayer(ClientMain.myPlayerNum).setMoney(Roster.getPlayer(ClientMain.myPlayerNum).getMoney() - fuelCost);
				fuelSpeed++;
	...
	private class mineButtonAL implements ActionListener {
		...
		public void actionPerformed(ActionEvent ev) {
			...
			if(Roster.getPlayer(ClientMain.myPlayerNum).getMoney() >= mineCost) {
				Roster.getPlayer(ClientMain.myPlayerNum).setMoney(Roster.getPlayer(ClientMain.myPlayerNum).getMoney() - mineCost);
				mineSpeed++;
