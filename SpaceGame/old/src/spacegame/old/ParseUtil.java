...
public class ParseUtil
{
    ...
    public static Vector parseStringBySign (String in, char sign)
    {   //This method returns a Vector of Strings created by
    ...
    public static String getHeader (String in, char sign)
    {   //This method returns the start of in until 'sign'.
        int z = 0;
...
//##########################################################################
    ...
    public static ArrayList<String> parseString (String in, char sign)
    {   //This method returns an ArrayList of Strings created by
        //parsing the input string on occurances of 'sign'.
    ...
    {   //This method returns the first four characters of 'in'
